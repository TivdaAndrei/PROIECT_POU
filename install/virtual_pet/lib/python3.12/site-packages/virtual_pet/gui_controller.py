...
class PetGUI(Node):
    def __init__(self):
        ...
        # Subscriber for voice chat messages
    ...
    def chat_callback(self, msg):
        """Display voice chat messages"""
        chat_message = msg.data
        if chat_message.startswith("You:"):
            self.add_alert(chat_message, "CHAT_USER")
        elif chat_message.startswith("Pou:"):
            self.add_alert(chat_message, "CHAT_PET")
